    ...
    <div className={languageMotionClass}>
      ...
      <section className={classes.stats}>
        <div className="container">
          <div className={`${classes.statsTop} iu-reveal iu-stagger-1`}>
          ...
          <div className={classes.statsGrid}>
            ...
            <div className={`${classes.statCard} iu-reveal iu-stagger-5 iu-hover-lift`}>
              <div className={classes.statIcon}>
      ...
      <section className={classes.section} id="services">
        <div className="container">
          <div className={`${classes.sectionHead} iu-reveal iu-stagger-6`}>
            <h2>{t("services_heading", "الخدمات الرقمية للمنصة")}</h2>
          </div>

          <div className={classes.servicesGrid}>
            <div className={`${classes.serviceCard} iu-reveal iu-stagger-7 iu-hover-lift`}>
            ...
            <div className={`${classes.serviceCard} iu-reveal iu-stagger-8 iu-hover-lift`}>
              <div className={classes.serviceIcon}>
            ...
            <div className={`${classes.serviceCard} iu-reveal iu-stagger-9 iu-hover-lift`}>
              <div className={classes.serviceIcon}>
                <IconQrcode size={32} stroke={1.75} color="var(--iu-icon, #0f172a)" />
              </div>
            ...
            <div className={`${classes.serviceCard} iu-reveal iu-stagger-10 iu-hover-lift`}>
              <div className={classes.serviceIcon}>
                <IconCertificate size={32} stroke={1.75} color="var(--iu-icon, #0f172a)" />
              </div>
      ...
      <section className={`${classes.section} ${classes.sectionLight}`}>
        <div className="container">
          <div className={`${classes.sectionHead} iu-reveal iu-stagger-11`}>
          ...
          {isLoading ? (
            ...
            <div className={classes.eventsGrid}>
              {events.map((event, idx) => (
                <div key={event.id} className={`iu-reveal iu-stagger-${Math.min(idx + 12, 17)}`}>
